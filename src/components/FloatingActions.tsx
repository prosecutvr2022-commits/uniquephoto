...
export const FloatingActions: React.FC<FloatingActionsProps> = ({ onOpenChat }) => {
  ...
  return (
    <div className="fixed bottom-6 left-6 z-40 flex flex-col gap-3 pointer-events-auto">
      ...
      {/* WhatsApp Button */}
      <a
        href="https://wa.me/919876543210?text=Hi%20Unique%20Capture%20Studio,%20I%20want%20to%20enquire%20about%20your%20photography%20services."
        target="_blank"
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="w-10 h-10 rounded-full bg-gradient-to-tr from-yellow-500 via-pink-500 to-purple-600 text-white shadow-xl flex items-center justify-center hover:scale-110 transition-transform duration-300 group relative"
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="w-10 h-10 rounded-full bg-[#1877F2] text-white shadow-xl flex items-center justify-center hover:scale-110 transition-transform duration-300 group relative"
        title="Facebook Page"
        aria-label="Facebook"
      >
